...
void testBayesianClassifier() {
    ...
    // The input domains
    domains.push_back(Domain(0.0, 3.0, 3));
    domains.push_back(Domain(0.0, 6.0, 6));
    domains.push_back(Domain(0.0, 4.0, 4));
    domains.push_back(Domain(0.0, 5.0, 5));
    domains.push_back(Domain(0.0, 2.0, 3));
    domains.push_back(Domain(0.0, 3.0, 3));
    domains.push_back(Domain(0.0, 1.0, 2));
    domains.push_back(Domain(0.0, 1.0, 2));
    domains.push_back(Domain(0.0, 7.0, 7));
    domains.push_back(Domain(0.0, 4.0, 4));
    domains.push_back(Domain(0.0, 1.0, 2));
    domains.push_back(Domain(0.0, 1.0, 2));
    domains.push_back(Domain(0.0, 2.0, 3));
